...
- [ ] Completed [Tutorial 1: Fundamentals](../../../lesson-1-fundamentals/docs/tutorial-1/INDEX.md)
...
If you missed this, review [Tool Calling Architecture](../../../lesson-1-fundamentals/docs/tutorial-1/concepts/tool-calling-architecture.md).
</details>
...
- **<13 correct (<65%):** ❌ **Not ready yet.** Complete [Tutorial 1](../../../lesson-1-fundamentals/docs/tutorial-1/INDEX.md) first, then retake this quiz.
...
- [Adding Custom Tools](../../../lesson-1-fundamentals/docs/lab-1/exercises/02-adding-tools.md)
- [Testing Methodology](../../../lesson-1-fundamentals/docs/tutorial-1/guides/testing-agents.md)
