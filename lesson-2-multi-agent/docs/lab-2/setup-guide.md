...
**If you haven't completed Tutorial 1:** Go to [Lab 1 Setup](../../../lesson-1-fundamentals/docs/lab-1/setup-guide.md)
...
- [Tutorial 1 Setup Guide](../../../lesson-1-fundamentals/docs/lab-1/setup-guide.md) - If environment needs repair
