...
- [ ] Completed [Tutorial 1: Fundamentals](../../../lesson-1-fundamentals/tutorial-1/READING_GUIDE.md)
...
👉 **[Take the Self-Assessment Quiz](./self-assessment.md)** (10 min, 20 questions)
- Passing score: 80% (16/20 correct)
- Covers Tool Calling, Multi-Agent Concepts, State & Communication, Testing
- Get instant feedback on what to review

**Or review:** [Tutorial 1 Concepts](../../../lesson-1-fundamentals/tutorial-1/concepts/tool-calling-architecture.md) before continuing.
...
- Reference [Tutorial 1](../../../lesson-1-fundamentals/tutorial-1/INDEX.md) for foundations
